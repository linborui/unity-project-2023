...
public class Pleague_doctor : AI
{
    ...
    void Update()
    {
        ...
        if(awareness == true) {
            ...
            else if(fsm.GetCurrentAnimatorStateInfo(0).IsName("stab")) acting = 3;
            else if(fsm.GetCurrentAnimatorStateInfo(0).IsName("cast0")) acting = 4;
            else if(fsm.GetCurrentAnimatorStateInfo(0).IsName("cast1")) acting = 5;
