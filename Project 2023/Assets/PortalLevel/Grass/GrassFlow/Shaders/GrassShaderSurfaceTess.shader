Shader "Hidden/Grass Material Shader With Surface Tesselation" {
	Properties {
		...
		tessRange("Tess Range", Float) = 20
		tessPow("Tess Pow", Float) = 1
		tessClose("Tess Close Fade", Range(0.001, 1.5)) = 1
		tessMin("Minimum Tess Factor", Range(1, 16)) = 0
